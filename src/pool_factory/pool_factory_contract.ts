...
export class PoolFactoryContractV3 extends PoolFactoryContractV2 {
  ...
  static readonly spec: contract.Spec = new contract.Spec([
    ...
    ...new contract.Spec([
      ...
      // Enum BackstopAsset
      'AAAAAgAAAD1PbmUgb2YgdGhlIGZvdXIgY2Fub25pY2FsIGFzc2V0cyBhY2NlcHRlZCBieSB0aGUgdjMgYmFja3N0b3AuAAAAAAAAAAAAAA1CYWNrc3RvcEFzc2V0AAAAAAAABAAAAAAAAAAAAAAAB0JsbnRYbG0AAAAAAAAAAAAAAAAIQmxudFVzZGMAAAAAAAAAAAAAAARVc2RjAAAAAAAAAAAAAAADWGxtAA==',
